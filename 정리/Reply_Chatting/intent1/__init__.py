...
<<<<<<< HEAD:rnn_intent/intent/__init__.py
from intent.rnn import RNN # intent 폴더 안에 있는 CNN 파일을 가져옴
from intent.lstm import LSTM # intent 폴더 안에 있는 LSTM 파일을 가져옴
...
__ALL__ = [CNN, LSTM]
>>>>>>> a8bdcdf2f552e0910108787822d444aa8951b41c:정리/Reply_Chatting/intent1/__init__.py
